...
| Day 2 | :heavy_check_mark:**验证二叉搜索树** | :heavy_check_mark:二叉树的最近公共祖先 | :heavy_check_mark:路径总和 III                               | LCA 很常考，尽量别跳                     |
| Day 3 | :heavy_check_mark:**二叉树的直径**   | :heavy_check_mark:二叉树展开为链表     | :heavy_check_mark:**从前序与中序遍历序列构造二叉树**<br />TODO：迭代算法 | 构造题能很好检验递归功底                 |
...
| Day 5 | :heavy_check_mark: **最长递增子序列** 贪心解法 | 序列 DP 代表题             |
| Day 6 | 最长公共子序列                                 | 二维 DP 代表题             |
| Day 7 | 单词拆分                                       | DP + 哈希/字典（大厂常问） |
